...
public class FileType {
    ...
    /**
     * Common File Head And Corresponding Extension
     */
    private static void getAllFileType()
    {
        ...
        FILE_TYPE_MAP.put("424d36ec5e0000000000", "bmp"); //32-bit(bmp)
        ...
        // FILE_TYPE_MAP.put("d0cf11e0a1b11ae10000", "wps");//WPS
    ...
    /**
     * Get Head of A Input File
     * @param src       Byte Flow of Input File Stream
     * @return          Hex Flow of Input File Stream
     */
    ...
    /**
     * Decide Type of A File According to Its Head
     * @param filePath      String File Path
     * @return              File Type of Input File Stream
     */
    ...
    public static String getFileType(File filePath){
        ...
        try {
            ...
            for (String key : FILE_TYPE_MAP.keySet()) {
                if (key.toLowerCase().startsWith(Objects.requireNonNull(fileCode).toLowerCase()) ||
