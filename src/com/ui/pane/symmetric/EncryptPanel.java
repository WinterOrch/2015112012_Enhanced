...
public class EncryptPanel extends JPanel {
    ...
    private void initialize(){
        logger = LoggerFactory.getLogger(EncryptPanel.class);
    ...
    private JPanel getCenterPanel(){
        ...
        inputFileLabel.setText(PropertiesLocale.getProperty("UI.SYMMETRIC.ENCRYPT.FILE"));
    ...
    private JPanel getDownPanel() {
        ...
        tip = new JLabel(PropertiesLocale.getProperty("UI.SYMMETRIC.ENCRYPT.TIP.OVERALL"));
                ...
                if(null == core) {
                    ...
                    new Thread(()->{
                        ...
                        if(option==JFileChooser.APPROVE_OPTION){
                            ...
                            try {
                                SymEncrypt.crypt(Cipher.ENCRYPT_MODE,fileForEncrypt,outputFile,core,
                                        PropertiesLocale.getConfig("SYMMETRIC.ALGORITHM"),
